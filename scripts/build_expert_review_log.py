...
def main() -> None:
    ...
    md = [
        ...
        (
            ...
            "current EGA II 2.2.1 cursor. It is complete ledger coverage, not a claim that EGA II, "
    ...
    receipt = {
        ...
        "coverage": (
            "Every current record in the four named public ledgers through EGA II 2.2.1; "
