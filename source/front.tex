...
{\large 한국어 누적판\par}
\vspace{0.5em}
{\small 현재 작업 범위: EGA I 완역과 EGA II 제1.7.4항까지\par}
...
제II장 제1절의 제1.1.1--1.7.4항까지의 연속 구간이다. EGA I는 완역되었고
EGA II 본문은 정본의 1--978행까지 연속해서 포함되었으며, EGA II 또는 EGA 전집 전체의 완성을
주장하지 않는다.
EGA 전체의 한국어 번역은 같은 DOI 계열과 공공 보존소들에서 끊김 없이 계속된다.
이 교정판은 수록 범위를 조밀한 연속 조판으로 압축하지 않고, 확인된 원 인쇄면
220쪽의 경계를 출력 쪽 리듬으로 보존한다. 판 정보와 목차를 포함한 독자용 PDF는
총 231쪽이다.
...
\href{https://doi.org/10.5281/zenodo.22143603}{10.5281/zenodo.22143603}
...
\noindent\textbf{작업 식별자:} 2026-08-28-r29\par
\clearpage
