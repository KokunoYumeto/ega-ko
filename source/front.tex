...
{\large 한국어 누적판\par}
\vspace{0.5em}
{\small 현재 작업 범위: EGA $0_{\mathrm I}$, EGA I, EGA II 및 EGA III-1\,·\,III-2 완역\par}
...
EGA I와 EGA II의 프로그램, 본문, 서지 및 부록 전체와 EGA III의 두
분책 전체이다. EGA III-1에는 제0장의 제8--13절, 제III장의 제1--5절,
참고문헌과 원 목차가 들어 있다. EGA III-2에는 제III장의 제6--7절,
참고문헌, 표기·용어 색인, 원 목차 및 정오표·추록이 정본 파일의 끝까지
들어 있다. 따라서 이 판은 EGA III-1과 EGA III-2를 합친 EGA III의
한국어 완역을 수록하지만, 뒤이은 EGA 권이나 EGA 전집 전체의 완성을
주장하지 않는다. EGA 전체의 한국어 번역은 같은 DOI 계열과 공공
보존소들에서 끊김 없이 계속된다. 이 교정판은 수록 범위를 조밀한 연속
조판으로 압축하지 않고, 확인된 667개의 원 인쇄면 경계를 출력 쪽
리듬으로 보존한다. 판 정보와 목차를 포함한 독자용 PDF의 총 쪽수와
최종 바이트 식별자는 이 판의 결정적 빌드 영수증에 기록한다.
...
\href{https://doi.org/10.5281/zenodo.22922228}{10.5281/zenodo.22922228}
...
\emph{AI typesetting \& translation}이다. 실제 한국어 번역·교정·조판은
\emph{OpenAI Codex --- GPT-5.6 Sol, Ultra effort}로 수행되었다.
...
\noindent\textbf{작업 식별자:} 2026-09-23-ega3-iii2-complete\par
\clearpage
