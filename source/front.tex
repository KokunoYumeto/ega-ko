...
{\large 한국어 누적판\par}
\vspace{0.5em}
{\small 현재 작업 범위: EGA I 완역(정본 드라이버의 모든 입력)\par}
...
그리고 제10절 처음부터 제10.15절 끝(원문 EOF)까지이다.
이로써 정본 드라이버가 열거한 EGA I의 모든 본문과 서지 입력을 완전히 옮겼다.
EGA 전집 전체의 완성을 주장하지 않는다.
...
\href{https://doi.org/10.5281/zenodo.22103931}{10.5281/zenodo.22103931}
...
\noindent\textbf{판 식별자:} 2026-08-26-r24\par
\clearpage
